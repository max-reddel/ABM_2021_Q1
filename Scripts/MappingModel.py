...
class MapModel(Model):
    """
    Converts pixels on given map image into Mesa grid.
        ...
        for obj, c in index_map:
            ...
            for pos in coords:
                try:
                    ...
                    # below: use string from colour_to_grid_object to match with the classes from inanimate agents
                    # parentheses after: init matched inanimate class with its associated args
